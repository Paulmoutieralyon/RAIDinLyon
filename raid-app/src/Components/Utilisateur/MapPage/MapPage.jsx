...
import {
  ...
  badTitle,
  actualTitle
} from "../../../Actions/Utilisateur/titleManagement_action.jsx";
import "./MapPage.css";
...
class MapPage extends React.Component {
  ...
  render() {
    return (
      <div>
        <NavLink to="../../">
          <button className="ButtonBack"> Retour </button>
        </NavLink>
                    ...
                    >
                      ...
                      <ModalBody className="modaltexte">
                        ...
                        <NavLink to="/EnigmePage">
                          {" "}
                          <button
                            onClick={() => this.props.displayEnigmeAction(i)}
                          >
                            Accéder à lénigme
                          </button>{" "}
                        </NavLink>
